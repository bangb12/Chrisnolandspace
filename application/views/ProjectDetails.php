    ...
    <div class="container-fluid">
        ...
        <section>
            <div id="MoreDetails">
                <?
                        if($id == 1){
                            echo('<img src="../../../img/portfolio/p1l.jpg" alt="Image of flash based game project" />');
                        ...
                        if($id== 2){
                            echo('<img src="../../../img/portfolio/p2l.jpg" / alt="Image of MediaZSearch application">');
                            echo('<h2>Project 2</h2>');
                            echo('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                 Phasellus purus ante, tristique id nulla vitae, hendrerit varius magna.
                                 Vestibulum libero eros, congue eget imperdiet vel, bibendum at velit. Nulla laoreet est nulla,
                                 consequat tristique velit tristique non. In ac sollicitudin justo, eget ornare velit.
